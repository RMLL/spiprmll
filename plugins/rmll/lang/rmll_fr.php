...
$GLOBALS[$GLOBALS['idx_lang']] = array(
    ...
    'titre_menu_programmes' => "Programmes",

    'titre_page_gestion' => 'Gestion des données',

    'label_gestion_jour' => "Gestion des jours",
    'label_gestion_horaire' => "Gestion des horaires",
    'label_gestion_langue' => "Gestion des langues",
    ...
    'label_notes' => 'Notes',
    'label_auditeurs' => 'Nombre d\'auditeurs (constaté)',
    ...
    'message_check_err' => "Le format des données est incorrect.",
    ...
    'planning' => "Planning",
    'feed_ical_name' => "Programmes des RMLL",
    'feed_ical_desc' => "Agenda des événements des Rencontres Mondiales du Logiciel Libre",
    'planning_ical' => "Télécharger le programme iCal (format vCalendar)",
    'planning_ical_theme' => "Télécharger le planning iCal du thème (format vCalendar)",
    'planning_ical_jour' => "Télécharger le planning iCal de la journée  (format vCalendar)",
