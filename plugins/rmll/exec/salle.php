...
function exec_salle() {
	...
	?>
		<table class="rmll">
			<tr>
				<th><?php echo _T('rmll:label_salle'); ?></th>
				<th><?php echo _T('rmll:label_capacite'); ?></th>
				<th></th>
			</tr>
	<?php
		foreach($datas as $d) {
	?>
			<tr>
				...
				<td><?php echo $d['capacite']; ?></td>
				<td>
			<?php
					/* bouton d'édition */
					Rmll_Helper::formulaire_debut(generer_url_ecrire('salle_edit'), array('class' => 'rmll_embed'));
					Rmll_Helper::formulaire_cache('id', $d['id_salle']);
					Rmll_Helper::formulaire_image('edit.png', '', null);
					Rmll_Helper::formulaire_fin();

					/* bouton de supprression */
					Rmll_Helper::formulaire_debut(generer_url_ecrire('salle'), array('class' => 'rmll_embed'));
					Rmll_Helper::formulaire_cache('suppr_id', $d['id_salle']);
