...
function exec_langue() {
	...
	icone_horizontale(_T('rmll:label_ajout'),
			generer_url_ecrire("langue_edit"), null, 
	...
	?>
			...
			<?php
					/* bouton d'édition */
					Rmll_Helper::formulaire_debut(generer_url_ecrire('langue_edit'), array('class' => 'rmll_embed'));
					Rmll_Helper::formulaire_cache('id', $d['id_langue']);
					Rmll_Helper::formulaire_image('edit.png', '', null);
					Rmll_Helper::formulaire_fin();
			
					/* bouton de supprression */
					Rmll_Helper::formulaire_debut(generer_url_ecrire('langue'), array('class' => 'rmll_embed'));
					Rmll_Helper::formulaire_cache('suppr_id', $d['id_langue']);
