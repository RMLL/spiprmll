...
function exec_jour_edit () {
    ...
    Rmll_Helper::icone_horizontale(
        _T('rmll:label_liste'), 'jour', 'liste.png');
    Rmll_Helper::icone_horizontale(
        _T('rmll:label_ajout'), 'jour_edit','ajout.png');
    ...
    for ($liste_mois = array(), $i=1; $i<=12;$i++) $liste_mois[$i] = strftime('%B', mktime(0, 0, 0, $i, 15, 2000));
