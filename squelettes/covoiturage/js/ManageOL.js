...
var ManageOL = OpenLayers.Class({
    ...
    */
	...
	this.markersTGV = new OpenLayers.Layer.Markers( "Gares TGV" , {legendurl:"./img/icon_gare.png",maxScale:800000,minScale:10000000,visibility:false});
	...
	,txtContent:"<span class='title_popup'>DAX : Gare TGV</span><span class='content_popup'>Dax - Mont de Marsan : 54 km<br> (compter 50min)<br></span><span class='footer_popup'>cliquer sur l'icone pour visualiser le trajet</span>"};
	...
	context:this,
	lieu:"Gare,Bordeaux"
	,txtContent:"<span class='title_popup'>Bordeaux: Gare TGV</span><span class='content_popup'>Bordeaux - Mont de Marsan : 130 km <br>(compter 1H20)<br></span><span class='footer_popup'>cliquer sur l'icone pour visualiser le trajet</span>"};
	marker.events.register("mouseover", params, this.markerover);
	marker.events.register("mouseout", params, this.markerout);
    marker.events.register("mousedown", params, this.setDirections);
	this.markersTGV.addMarker(marker);
	...
	,txtContent:"<span class='title_popup'>Bayonne: Gare TGV</span><span class='content_popup'>Bayonne - Mont de Marsan : 105 km<br> (compter 1H10)<br></span><span id='footer_p_Bayonne' class='footer_popup'>cliquer sur l'icone pour visualiser le trajet</span>"};
	marker.events.register("mouseover", params, this.markerover);
	marker.events.register("mouseout", params, this.markerout);
    marker.events.register("mousedown", params, this.setDirections);
	this.markersTGV.addMarker(marker);
	...
	context:this,
	lieu:"Gare,Toulouse"
	,txtContent:"<span class='title_popup'>Toulouse: Gare TGV</span><span class='content_popup'>Toulouse - Mont de Marsan : 224 km<br> (compter 2H40)<br></span><span id='footer_p_Toulouse' class='footer_popup'>cliquer sur l'icone pour visualiser le trajet</span>"};
	marker.events.register("mouseover", params, this.markerover);
	marker.events.register("mouseout", params, this.markerout);
    marker.events.register("mousedown", params, this.setDirections);
	this.markersTGV.addMarker(marker);
	...
	var iconRestau = new OpenLayers.Icon("./img/icon_restaurant.png", new OpenLayers.Size(30,30));
	var RestauRMLL = new OpenLayers.Layer.GeoRSS( 'Restauration et Hébergement RMLL', 'Heb_Resto_RMLL_OL.xml', {legendurl:"./img/icon_restaurant.png",'icon':iconRestau,minScale:100000});
