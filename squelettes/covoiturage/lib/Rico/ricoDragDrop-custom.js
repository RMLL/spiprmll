...
/**
  *
  *  Aug 7, 2007
  *  Modified by Gilles Bassière (Makina Corpus) in order to:
  *   1) make objects droppable anywhere (DropZone not required)
  *   2) support an handle system on the draggable element
  *
  **/
...
/*      if (Element.getStyle(dragElement,'position')=='absolute')*/
   ...
   **/
   ...
   _mouseUpHandler: function(e) {
      ...
      /* In our case an object might be dropped anywhere. Thus the if-block is to be removed. */
...
Rico.includeLoaded('ricoDragDrop-custom.js');
